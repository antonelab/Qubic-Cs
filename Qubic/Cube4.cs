    ...
    public class Cube4 : Cube {
         ...
         public void print()
        {
            ...
            for(int j=1;j<3;j++){
                ...
                Console.Write("| /");
                Console.WriteLine(" " + cube[j][3][0] + " / " + cube[j][3][1] +
            ...
            Console.Write("|       /");
            Console.WriteLine(" " + cube[3][0][0] + " / " + cube[3][0][1] +
             " /|" + cube[3][0][2] + " / " + cube[3][0][3] + " /");
            //linija
            Console.WriteLine("|      /___/___/_|_/___/ ");
            //drugi redak cetvrtog levela
            Console.Write("|     /");
            Console.WriteLine(" " + cube[3][1][0] + " / " + cube[3][1][1] +
             " / " + cube[3][1][2] + "|/ " + cube[3][1][3] + " /  ");
            //linija
            Console.WriteLine("|    /___/___/___|___/");
            //treci redak cetvrtog levela
            Console.Write("|   /");
            Console.WriteLine(" " + cube[3][2][0] + " / " + cube[3][2][1] +
             " / " + cube[3][2][2] + " /|" + cube[3][2][3] + " /");
            //linija
            Console.WriteLine("|  /___/___/___/_|_/");
            //cetvrti redak cetvrtog levela
            Console.Write("| /");
            Console.WriteLine(" " + cube[3][3][0] + " / " + cube[3][3][1] +
